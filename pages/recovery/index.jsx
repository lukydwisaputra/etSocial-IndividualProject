...
import { createStyles, Paper, Title, Text, TextInput, Button, Container, Group, Autocomplete } from '@mantine/core'
...
export default function ForgotPassword(props) {
	...
	return (
		<>
			...
			<div className="d-flex justify-content-center align-items-center p-0" style={{ minHeight: '70vh', marginTop: '5vh' }}>
				<Container size={'sm'} my={30} style={{ maxWidth: '500px' }}>
					...
					<Paper shadow="xs" p={30} radius="md" mt="xl" style={{ border: border }}>
						...
						<Group mt="lg" className={classes.controls}>
							<Button size="xs" variant="light" color="gray" type="submit" className="d-flex" onClick={() => {}}>
								Send recovery link
							</Button>
						</Group>
					</Paper>
