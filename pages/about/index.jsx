        ...
        <>
            <div>
                ...
                <div className="container">
					...
					<hr />
					<article>
						<Text className="fs-4 fw-bold mb-3" style={{marginTop: '1vh'}}>For creators, by creators</Text>
						...
						<Image radius={'sm'}  src={'https://assets-global.website-files.com/625d2a5ca1316da92392fd13/62af4edd501088c08b2cad24_cover.png'} height={350} width={'100%'} style={{marginTop: '3vh'}}/>
						<p className="mt-2 fw-light" style={{ textAlign: 'justify', marginBottom: '7vh'}}>We believe you are too. You’re our inspiration. We believe that with the right creative tools, inspiring resources, and a supportive community, you can do anything. We’re investing in you. Join us.</p>
					</article>
				</div>
            </div>
        </>
