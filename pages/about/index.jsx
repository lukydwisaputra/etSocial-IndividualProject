			...
			<div>
				...
				<div className="container">
					...
					<article style={{ marginTop: '5vh' }}>
						...
						<Image alt="about_us_1" radius={'sm'} src={about_us_1} objectFit="cover" layout="responsive" />
					...
					<article style={{ marginTop: '5vh', marginBottom: '2.5vh' }}>
						<Text className="fs-4 fw-bold mb-3" style={{ marginTop: '1vh' }}>
							Our inspiration today
						</Text>

						<Image alt="about_us_2" radius={'sm'} src={about_us_2} objectFit="cover" layout="responsive" />
						...
						<Image alt="about_us_3" radius={'sm'} src={about_us_3} objectFit="cover" layout="responsive" />
