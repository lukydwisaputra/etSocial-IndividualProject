...
import { createStyles, Avatar, Indicator, ActionIcon, Tooltip, Text } from "@mantine/core";
...
function LeftSidebarComponent() {
	...
	const isLoginUser = pathname.includes('login') || pathname === '/' || pathname === '/about';
				...
				<div style={{position: 'fixed', bottom: '2.5%'}}>
					...
					<div className={rowStyle}>
						<Tooltip
							...
							<Link href="/" passHref>
								<ActionIcon component="button" className={buttonStyle} style={classes.theme}>
									<Indicator inline size={10} offset={0} position="bottom-end" color="red">
										<Avatar
											src={
